...
<nav class="navbar background">
        ...
        <a href="Login.php"><input type="submit" class=" btn-primary" value="Login" ></a>
        <a href="signup.php"><input type="submit" class=" btn-primary" value="Register" ></a>
 ...
 <section class="background firstSection" id="#Home">
        <div class="box-main">
            <div class="firstHalf">
                <p class="text-big">Car Rental Company Ltd</p>
                <p class="text-small">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore incidunt laudantium minus, necessitatibus consequuntur cumque et, consectetur nemo veritatis doloremque libero illum.</p>
   ...
   $db = mysqli_select_db($conn, 'carrental');
    ...
    <section class="contact" id="contact">
        ...
        <center> <input type="text" class="form-control text-center" placeholder="Enter your name" name="cname" required="required"> </center> 
        </div>
        <div class="form-group text-center" >
